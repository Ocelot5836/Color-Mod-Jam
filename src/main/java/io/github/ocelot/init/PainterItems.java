...
public class PainterItems
{
    ...
    public static final RegistryObject<WorldPaintingItem> WORLD_PAINTING = ITEMS.register("world_painting", () -> new WorldPaintingItem(new Item.Properties().group(WorldPainter.TAB)));
}
